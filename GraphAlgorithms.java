...
public class GraphAlgorithms {
   ...
   */
  public   <V,E> void DFS(Graph<V,E> g, Vertex<V> u,
   ...
   */
  public  <V,E> PositionalList<Edge<E>>
   ...
   */
  public   <V,E> Map<Vertex<V>,Edge<E>> DFSComplete(Graph<V,E> g) {
   ...
   * and adds discovery graph edges to the forest.
   */
  public   <V,E> void BFS(Graph<V,E> g, Vertex<V> s,
                    Set<Vertex<V>> known, Map<Vertex<V>,Edge<E>> forest) {
   ...
   */
  public   <V,E> Map<Vertex<V>,Edge<E>> BFSComplete(Graph<V,E> g) {
    Map<Vertex<V>,Edge<E>> forest = new ProbeHashMap<>();
    Set<Vertex<V>> known = new HashSet<>();
    for (Vertex<V> u : g.vertices())
      if (!known.contains(u))
   ...
   */
  public   <V> Map<Vertex<V>,Edge<Integer>>
